...
public class ModuleNormalizedCoordsConfigScreen extends GenericManipulatorScreen {
	...
	public Module getModule() {
		ModuleNormalizedCoords moduleNormalizedCoords = new ModuleNormalizedCoords();

		moduleNormalizedCoords.setSource(getManipulatingModule());
		moduleNormalizedCoords.setLength(getManipulatingModule(1));

		return moduleNormalizedCoords;
	}
	...
	public GenericManipulatorScreen copy() {
		return new ModuleNormalizedCoordsConfigScreen();
	}
