...
public class ModuleTriangleConfigScreen extends GenericManipulatorScreen {
	...
	public Module getModule() {
		...
		moduleTriangle.setSource(getManipulatingModule());
		moduleTriangle.setPeriod(getManipulatingModule(1));
		moduleTriangle.setOffset(getManipulatingModule(2));

		return moduleTriangle;
	}
	...
	public GenericManipulatorScreen copy() {
		return new ModuleTriangleConfigScreen();
	}
