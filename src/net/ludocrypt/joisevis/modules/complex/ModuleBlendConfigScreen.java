...
public class ModuleBlendConfigScreen extends GenericManipulatorScreen {
	...
	public Module getModule() {
		...
		moduleBlend.setControlSource(getManipulatingModule());
		moduleBlend.setLowSource(getManipulatingModule(1));
		moduleBlend.setHighSource(getManipulatingModule(2));
	...
	public GenericManipulatorScreen copy() {
		return new ModuleBlendConfigScreen();
	}
	...
	public JPanel getManipulationPanel(int manipulator) {
		return new JPanel(new GridLayout()) {
			...
			protected void paintComponent(Graphics g) {
				...
				switch (manipulator) {
				case 0:
					g.drawString("Control Source", 3, 12);
					break;
				case 1:
					g.drawString("Low Source", 3, 12);
					break;
				case 2:
					g.drawString("High Source", 3, 12);
					break;
				}
